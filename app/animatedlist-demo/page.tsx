...
let notifications = [
  {
    name: "Trader X joined the platform",
    description: "New member onboarded",
    time: "15m ago",
    icon: "🚀",
    color: "#00C9A7",
  },
  {
    name: "Trader Y hit a new milestone",
  ...
  {
    name: "Trader Z updated their profile",
  ...
  {
    name: "Trader X received a new tip",
    description: "Boost your discipline",
    time: "2m ago",
    icon: "📈",
    color: "#1E86FF",
  },
